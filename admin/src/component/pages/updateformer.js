                    ...
                    <form onSubmit={handleSubmit} >
                        <Grid>
                            <Typography>INFORMATIONS GENERALES</Typography>
                                 ...
                                 <div> <FileBase type="file" name="choisir une image" multiple={false} onDone={({ base64 }) => setUsername({ ...username, selectedimage: base64 })} />
                                 <Avatar className={classes.avatar} alt="imageformer" src={username.selectedimage} ></Avatar>
                                 <TextField name='firstname' variant="outlined" label="Nom" value={username.firstname} onChange={handlechangenom} ></TextField>
                                 <TextField name='lastname' variant="outlined" label="Prenom" value={username.lastname} onChange={handlechangeprenom} ></TextField>
                                 <TextField name='email' variant="outlined" label="Email" value={username.email} onChange={handlechangeemail} ></TextField>
                                 <TextField name='phone' variant="outlined" label="Telephone" value={username.phone} onChange={handlechangetel}></TextField>
                                 <TextField name='cin' variant="outlined" label="Numero de carte d'identité" value={username.cin} onChange={handlechangecin}></TextField>
                                 <TextField required className={classes.textf} name='Numbreofexperience ' variant="outlined" label=" Année  d'expérience (ans)" type="number" value={username.Numbreofexperience} onChange={(e) => setUsername({ ...username, Numbreofexperience: e.target.value })} ></TextField>
                                 ...
                                 <Typography className={classes.labela} >modifier le  CV </Typography>
                                 <FileBase type="file" name="choisir un CV" multiple={false} onDone={({ base64 }) => setUsername({ ...username, selectedFile: base64 })} />
                                 <Select onChangeData2={onChangeData2} speciality={speciality} value={username.namespeciality}></Select>
