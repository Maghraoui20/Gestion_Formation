      ...
      <form className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit} >
        <Grid container item xs={6} md={12} lg={12} >
          ...
          <Mapformer 
            ...
            <TextField className={classes.Textfiled} required name='nameformer' variant="outlined" label="nom du formateur" type="string" value={formationData.name_former} onChange={(e) => setformationData({ ...formationData, name_former: e.target.value })} style={{ width: 360, marginTop: 15 }}></TextField>
