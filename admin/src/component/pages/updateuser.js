...
const Updateuser = () => {
    ...
    const [userinfos, setuserinfos] = useState(JSON.parse(localStorage.getItem('client')));
    const [userData, setuserData] = useState({ firstname:userinfos.allusers[1], lastname:userinfos.allusers[2], phone:userinfos.allusers[8], email:userinfos.allusers[7], cin:userinfos.allusers[5], gouvernorate:userinfos.allusers[3], city:userinfos.allusers[4], selectedimage:userinfos.allusers[6], mdpactuel: '', password: '', confirmerMotdepasse: '' })
