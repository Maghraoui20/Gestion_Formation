...
import { Avatar, Button, Paper, Grid, TextField, Typography } from '@material-ui/core';
...
const UpdateCenter = () => {
    ...
    const [userinfos, setuserinfos] = useState(JSON.parse(localStorage.getItem('center')));
    const [userData,setuserData] = useState({firstname:[userinfos.allcenter[2]], lastname:userinfos.allcenter[1],phone:userinfos.allcenter[6],email:userinfos.allcenter[5] ,selectedimage:userinfos.allcenter[7], 
        namegouvernorate:userinfos.allcenter[3],namecities:userinfos.allcenter[4],adressexact:userinfos.allcenter[8],namespeciality:userinfos.allcenter[2], description:userinfos.allcenter[9]
    });
                    ...
                    <form onSubmit={handleSubmit} >
                        <Grid>
                            <Typography>INFORMATIONS GENERALES</Typography>
                             ...
                             <FileBase type="file" name="choisir une image" multiple={false} onDone={({ base64 }) => setuserData({ ...userData, selectedimage: base64 })} />
