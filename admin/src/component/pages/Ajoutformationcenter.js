...
import { TextField, Button, FormLabel, Paper, Grid,Typography} from '@material-ui/core';
...
import { creatTrainingcenter} from '../../actions/trainings';
...
const Formulaire = ({ currentId, setCurrentId }) => {
      ...
      <form className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit} >
        <Grid container item xs={6} md={12} lg={12} >
          ...
          <Mapformer 
            ...
            <TextField className={classes.Textfiled} required name='namecenter' variant="outlined" label="nom du centre" type="string" value={formationData.name_center} onChange={(e) => setformationData({ ...formationData, name_center: e.target.value })} style={{ width: 360, marginTop: 15 }}></TextField>
