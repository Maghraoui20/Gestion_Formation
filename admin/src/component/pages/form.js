...
import { getTrainingbyid, updateTraining } from "../../actions/trainings";
...
const UpdateForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (extension === "/jpeg" || extension === "/jpg" || extension === "/png") {
      dispatch(updateTraining(id, formationData, history));
      alert(" Succés !");
      clear();
    } else {
        ...
        <Grid container item xs={6} md={12} lg={12}>
          <Grid item xs={12} md={6} lg={6}>
            ...
            <Select
              ...
              categorie={categorie}
              value={formationData.namecategorie}
            />
            <MaterialUIPickers
              onChangeFirstDate={onChangeFirstDate}
              onChangeLastDate={onChangeLastDate}
              firstdate={moment(formationData.firstdate).format("yyyy-MM-DD")}
              lastdate={moment(formationData.lastdate).format("yyyy-MM-DD")}
            />
            ...
            <Selectgouvernorat
              ...
              value={formationData.namegouvernorate}
            />

            <SelectCities
              handleChangecity={handleChangecity}
              filtredCity={filtredCity}
              value={formationData.namecity}
            />
             <TextField
              required
              name="description "
          ...
          <Typography className={classes.typoggraphy}>Entrer la localisation</Typography>

<div className={classes.map}>
 <div className={classes.divtext}>  <TextPoint value={x} />
<TextPoint1  value={y} /> </div>
  ...
  />
            ...
            <Typography className={classes.typoggraphy}>Objectifs de formation</Typography>
            <TextEditor
