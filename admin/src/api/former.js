...
const url1 = 'http://localhost:5010/former/formers';
const url2 = 'http://localhost:5010/former/Allformers';

const url3= 'http://localhost:5010/former/delete';
const url4 ="http://localhost:5010/former/signup";
const url5 = 'http://localhost:5010/former/search';
