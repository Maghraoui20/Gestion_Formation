...
const url1 = 'http://localhost:5010/centre/centers';
const url2 = 'http://localhost:5010/centre/centers';
const url3= 'http://localhost:5010/centre/delete';
const url4 = 'http://localhost:5010/centre/search';
