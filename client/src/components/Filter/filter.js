...
const [filter,SetFilter]=useState({CategoriesIds:[],Prices:[0,10000],Heures:[0,150],GouvernoratIds:[],citiesids:[], Datedeb :date, Datefin:date });
...
return (
    <Paper className={classes.Paper}>
     ...
     <Datefilter OnfilterApplyDuree= {filterApplyDuree}  OnfilterApplyDatedebut={filterApplyDatedebut} OnfilterApplyDatefin={filterApplyDatefin}  />
    </Scrollbars>
    </Paper>
    )
};
